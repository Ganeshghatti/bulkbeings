...
export function Testmodel2(props) {
  const group = useRef();

  const { nodes, materials } = useGLTF("./public/assets/model/testmodel2.gltf");
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <mesh
        geometry={nodes.Particle_sim_logo.geometry}
        material={nodes.Particle_sim_logo.material}
        position={[0.093, 1.892, 0]}
        rotation={[0, 0, 3.106]}
        scale={[0.019, 0.031, 0.031]}
      />
      <mesh
...
useGLTF.preload("./public/assets/model/testmodel2.gltf");
